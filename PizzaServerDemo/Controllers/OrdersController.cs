...
namespace PizzaServerDemo.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        public OrdersController(PizzaServerDemoContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<IEnumerable<Order>>> GetOrder()
        {
            ...
            var temp = await _context.Order
                .Select(o => 
                new { o.OrderID, o.TotalCost
                }).ToListAsync();
        ...
        {
            //var temp = await _context.Order
            //    .Select(o => new { o.OrderID, o.TotalCost })
        ...
        public async Task<ActionResult<Order>> PostOrder(Order order)
        {
            ...
            int temp = _context.Order.Max(i => i.OrderID);
            return Ok(temp);
        }
